...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='𝝺'
  ...
  # If set to false, hide node version if it's equal to "system".p10
  ...
  # Google application credentials classes for the purpose of using different colors, icons andp10
  ...
  # kanagawa Theme
  typeset -g COLOR_BACKGROUND="#1f1f28bf"    # bl: dark background
  typeset -g COLOR_FOREGROUND="#dcd7ba"    # na: main text

  # --- ANSI colors ---
  typeset -g COLOR_BLACK="#171616"         # bl: dark background
  typeset -g COLOR_RED="#c34043"           # ia: intense red
  typeset -g COLOR_GREEN="#76946a"         # va: soft green
  typeset -g COLOR_YELLOW="#f8c630"        # ca: beige
  typeset -g COLOR_BLUE="#082136"          # va: light blue
  typeset -g COLOR_ROSE="#49111C"
  typeset -g COLOR_MAGENTA="#0f0b25"       # ca: lavender
  typeset -g COLOR_CYAN="#588B8B"          # va: teal
  typeset -g COLOR_WHITE="#F2F4F3"         # na: light gray
  ...
  typeset -g COLOR_BRIGHT_BLUE="#475563"   # va: bright blue
  typeset -g COLOR_BRIGHT_MAGENTA="#938aa9" # ca: bright lavender
  typeset -g COLOR_BRIGHT_CYAN="#5B8A93"   # va: bright teal
  ...
  # Directory
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$COLOR_MAGENTA
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$COLOR_BRIGHT_CYAN
  ...
  # Other elements
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=$COLOR_GREEN
